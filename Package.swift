...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/percypyan/pyan-logging.git", .upToNextMajor(from: "0.4.0")),
		.package(url: "https://github.com/percypyan/pyan-feature-switcher.git", .upToNextMajor(from: "0.2.2")),
		.package(url: "https://github.com/percypyan/pyan-testing.git", .upToNextMajor(from: "0.1.2")),
